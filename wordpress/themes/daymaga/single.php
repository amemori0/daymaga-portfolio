    ...
    <div class="p-single__inner">
      <div class="p-single__contents">
        ...
        <div class="p-single__toc">
          <?php get_template_part("template-parts/single/toc", null, [
        ...
        <div class="p-single__content">
          ...
          if (!empty($faq_items)):
            get_template_part("template-parts/single/faq", null, [
              "items" => $faq_items,
            ]);
          endif;
          ?>
          ...
          <div class="p-single__footnotes">
            <?php get_template_part("template-parts/single/footnotes"); ?>
          </div>

          <div class="p-single__closing">
            <?php get_template_part("template-parts/single/closing"); ?>
          </div>
